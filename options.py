...
class_map = {0: ['rgb/data'], 
             1: ['rain/50mm', 'fog/150m', 'snowgan/data'], 
             2: ['mix_rain/50mm', 'fog/75m', 'mix_snow/data'], 
             None: []}
...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--mix_rate",
            nargs="+",
            help="if --use the pre-define curriculum learning, use this value to control the curriculum learning: "
                  "e.g. set to [0,0.5], and total epoch=20 we train the 1st level 10 epoch, 2nd level last 10 epoch.",
            type=float,
            default=[0, 0.5])
